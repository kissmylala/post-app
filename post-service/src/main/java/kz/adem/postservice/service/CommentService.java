...
public interface CommentService {
    ...
    PostCommentDto deleteComment(Long postId, Long commentId, String username, Long userId);
    ...
    PostCommentDto createCommentToPost(CommentDto commentDto, Long postId, String username, Long userId);
